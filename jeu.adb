...
begin 
   loop 
      begin 
         Ada.Text_Io.Put ("Qui debute ? "); Quel := Cellules.Symbole'Value (''' & Ada.Text_Io.Get_Line & '''); exit; 
      exception 
   ...
   loop 
      ...
      if Grille.IsFull (Un_Plateau) then 
         Ada.Text_Io.Put_Line (" Partie terminée :EGALITÉ "); exit; 
      else 
         ...
         begin 
            ...
            if not Grille.IsEmpty (Un_Plateau => un_plateau, 
               ...
               Grille.Tracer (Un_Plateau => un_plateau, 
                                ...
                                Un_Symbole => Quel); 
               Afficher; 
               Ada.Text_Io.Put_Line ("Partie terminée: "&cellules.symbole'Image (quel) & " VAINQUEUR "); 
               exit; 
            else 
               Grille.Tracer (Un_Plateau => un_plateau, 
                                X          => X, 
